...
const CACHE = `${CACHE_PREFIX}v18-portraits-badges`;
const ASSETS = [...new Set([
  ...
  ...Object.values(globalThis.TIDEGLASS_COMPANION_ART).map(file => `./${file}`),
  ...Object.values(globalThis.TIDEGLASS_COLLECTION_ART).map(file => `./${file}`)
])];
